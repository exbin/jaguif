 ...
 */
package org.exbin.jaguif.operation.undo.action;
...
public class UndoAction extends AbstractAction implements ActionContextChange {
    ...
    public void updateByContext(ContextUndoRedo context) {
        undoRedo = context instanceof UndoRedoState ? (UndoRedoState) context : null;
