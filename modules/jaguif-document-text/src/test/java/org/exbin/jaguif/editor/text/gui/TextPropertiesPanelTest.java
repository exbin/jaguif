 ...
 */
package org.exbin.jaguif.editor.text.gui;

import org.exbin.jaguif.document.text.gui.TextPropertiesPanel;
...
/**
 * Test for TextPropertiesPanel.
 */
public class TextPropertiesPanelTest {
    ...
    public void testPanel() {
        ...
        testApplication.launch(() -> {
            ...
            WindowUtils.wrapInWindow(new TextPropertiesPanel());
        });
    }
}
