 ...
 */
package org.exbin.jaguif.update.check.contribution;
...
public class CheckForUpdateContribution implements ActionSequenceContribution {
    ...
    public Action createAction() {
        UpdateCheckModuleApi updateCheckModule = App.getModule(UpdateCheckModuleApi.class);
        Action action = updateCheckModule.getCheckUpdateAction();
        return action;
    }
