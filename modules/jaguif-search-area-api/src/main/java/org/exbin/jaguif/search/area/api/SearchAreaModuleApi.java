 ...
 */
package org.exbin.jaguif.search.area.api;
...
/**
 * Interface for search for area module.
 */
@NullMarked
public interface SearchAreaModuleApi extends Module {

    public static final String MODULE_ID = ModuleUtils.getModuleIdByApi(SearchAreaModuleApi.class);
