 ...
 */
package org.exbin.jaguif.update.check.gui;
...
/**
 * Test for CheckForUpdatePanel.
 */
public class CheckForUpdatePanelTest {
    ...
    public void testPanel() {
        ...
        testApplication.launch(() -> {
            ...
            WindowUtils.wrapInWindow(new CheckForUpdatePanel());
        });
    }
}
