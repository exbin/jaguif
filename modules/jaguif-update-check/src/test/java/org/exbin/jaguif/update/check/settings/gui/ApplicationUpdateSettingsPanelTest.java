 ...
 */
package org.exbin.jaguif.update.check.settings.gui;
...
/**
 * Test for ApplicationUpdateSettingsPanel.
 */
public class ApplicationUpdateSettingsPanelTest {
    ...
    public void testPanel() {
        ...
        testApplication.launch(() -> {
            ...
            WindowUtils.wrapInWindow(new ApplicationUpdateSettingsPanel());
        });
    }
}
