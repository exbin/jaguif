 ...
 */
package org.exbin.jaguif.update.check.service;
...
import org.exbin.jaguif.update.check.UpdateCheckModule;
import org.exbin.jaguif.update.check.service.CheckForUpdateService.BackgroundCheckListener;
import org.exbin.jaguif.update.check.service.CheckForUpdateService.CheckForUpdateResult;
...
public class DefaultCheckForUpdateService implements CheckForUpdateService {
    ...
    private final UpdateCheckModule guiUpdateModule;

    private Thread checkingThread = null;

    public DefaultCheckForUpdateService(UpdateCheckModule guiUpdateModule) {
