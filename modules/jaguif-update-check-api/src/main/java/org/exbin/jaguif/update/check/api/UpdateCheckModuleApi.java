 ...
 */
package org.exbin.jaguif.update.check.api;
...
/**
 * Interface of the update availability checking module.
 */
@NullMarked
public interface UpdateCheckModuleApi extends Module {

    public static final String MODULE_ID = ModuleUtils.getModuleIdByApi(UpdateCheckModuleApi.class);
